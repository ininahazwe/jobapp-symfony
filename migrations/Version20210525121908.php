...
final class Version20210525121908 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE dictionary (id INT AUTO_INCREMENT NOT NULL, file_id INT DEFAULT NULL, type VARCHAR(128) NOT NULL, value VARCHAR(256) NOT NULL, INDEX IDX_1FA0E52693CB796C (file_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE dictionary ADD CONSTRAINT FK_1FA0E52693CB796C FOREIGN KEY (file_id) REFERENCES dictionary (id) ON DELETE SET NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE dictionary DROP FOREIGN KEY FK_1FA0E52693CB796C');
